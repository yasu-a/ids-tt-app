...
def index():
    return render_template(
        'marton/marton/../../templates/main/index.html'
    )


@marton.route('/sear', methods=['post'])
def sear():
...
@marton.route('/send', methods=['post', 'get'])
def send():
    ...
    return render_template('marton/marton/../../templates/main/display.html')


@marton.route('/form')
def form():
    return render_template(
        'marton/marton/../../templates/main/form.html'
    )


@marton.route('/display')
def display():
    return render_template(
        'marton/marton/../../templates/main/display.html'
    )


@marton.route('/register', methods=['post', 'get'])
def register():
    date = request.form['date']
...
def delete():
    return render_template(
        'marton/marton/../../templates/main/delete.html'
    )


@marton.route('/dele', methods=['post'])
def dele():
